...
setup(name='pysmo.aimbat_qt',
	...
	author_email='arnavsankaran@gmail.com',
	...
	package_data={'pysmo.aimbat_qt': ['ttdefaults.conf', 'stationplottingtemplate.map', 'Readme.md', 'Version.txt', 'License.txt', 'Changelog.txt']},
	long_description="\n".join(doclines[2:]),
